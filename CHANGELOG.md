...
- Wrapped objective lines indent by the width of `- `, so a continuation like `0/10` lines up under the objective text instead of under the dash

## [1.1.15] - 2026-08-27

### Fixed

- Tracker no longer errors on load (`attempt to call a nil value` in `TrackerLines:Initialize`)
...
- Tightened the tracker gap between numbered circles and titles, and the extra space after quests with no objectives
